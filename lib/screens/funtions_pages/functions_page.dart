      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child:
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(20.r),
                            gradient: const LinearGradient(
                              colors: [ColorUtils.grad_light_green, ColorUtils.grad_green],
                              begin: Alignment.topCenter,
                              end: Alignment.bottomCenter,
                            ),
                            image: const DecorationImage(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(20.r),
                            gradient: const LinearGradient(
                              colors: [ColorUtils.grad_light_pink, ColorUtils.grad_lighter_pink],
                              begin: Alignment.topCenter,
                              end: Alignment.bottomCenter,
                            ),
                            image: const DecorationImage(
            ...
            const Text('开发中...',style: TextStyle(fontSize: 32,fontFamily: 'LanSong',color: ColorUtils.text_brown),)
          ]),
        ),
      ),
    );
