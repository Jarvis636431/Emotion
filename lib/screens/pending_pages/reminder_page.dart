      ...
      child: Column(
        children: [
         IconButton(
          ...
          Text('新建提醒事项',style: TextStyle(fontSize: 24.sp,fontFamily: 'LanSong',color: ColorUtils.text_brown),),
          SizedBox(
            height: 200.w,
            ...
            child: ListView(
              children: [
                ListTile(
                  ...
                  subtitle: Text('提醒事件：12:00',style: TextStyle(fontSize: 14.sp,color: ColorUtils.subtitle),),
                  trailing: Container(
                    //封装好组件，点击切换状态
                    decoration: BoxDecoration(
                      color: ColorUtils.info_card_bg,
                      borderRadius: BorderRadius.circular(20.r),///设计图神秘圆角
                    ),
                    child: Padding(
                      padding:EdgeInsets.symmetric(horizontal: 10.h,vertical: 5.w),
                      child: Text('已完成',style: TextStyle(fontSize: 14.sp,color: ColorUtils.text_brown),),
                    ),
                  ),
                ),
                ListTile(
                  ...
                  trailing: Container(
                    ...
                    child: Padding(
                      padding:EdgeInsets.symmetric(horizontal: 10.h,vertical: 5.w),
                      child: Text('未提醒',style: TextStyle(fontSize: 14.sp,color: ColorUtils.text_brown),),
                    ),
                  ),
                ),
                ListTile(
